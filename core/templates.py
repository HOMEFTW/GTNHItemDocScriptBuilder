...
RECIPE_MAP_NAMES_ZH = {
    ...
    "gt.recipe.plasmaforge": "等离子锻炉",
    "gt.recipe.transcendentplasmamixerrecipes": "超越等离子混合器",
    "gt.recipe.fakespaceprojects": "模拟太空项目",
    "gt.recipe.primitiveblastfurnace": "原始高炉",
    "gt.recipe.implosioncompressor": "内爆压缩机",
    ...
    "gt.recipe.craker": "裂化机",
    "gt.recipe.pyro": "热解炉",
    "gt.recipe.wiremill": "线材轧机",
    "gt.recipe.metalbender": "板材弯曲机",
    ...
    "gt.recipe.lathe": "车床",
    "gt.recipe.cuttingsaw": "切割锯",
    "gt.recipe.slicer": "切片机",
    "gt.recipe.extruder": "挤压机",
    "gt.recipe.hammer": "锻锤",
    ...
    "gt.recipe.pcbfactory": "PCB 工厂",
    "gt.recipe.ic2nuke": "IC2 核弹",
    "gtpp.recipe.cokeoven": "GT++ 焦炉",
    "gtpp.recipe.matterfab2": "GT++ 物质发生器",
    "gtpp.recipe.rocketenginefuel": "GT++ 火箭引擎燃料",
    "gtpp.recipe.quantumforcesmelter": "GT++ 量子力熔炉",
    "gtpp.recipe.geothermalfuel": "GT++ 地热燃料",
    "gtpp.recipe.chemicaldehydrator": "GT++ 化学脱水机",
    "gtpp.recipe.vacfurnace": "GT++ 真空炉",
    "gtpp.recipe.alloyblastsmelter": "GT++ 合金高炉",
    ...
    "gtpp.recipe.cyclotron": "GT++ 回旋加速器",
    "gtpp.recipe.slowfusionreactor": "GT++ 慢速聚变反应堆",
    "gtpp.recipe.componentassembler": "GT++ 组件组装机",
    "gtpp.recipe.fishpond": "GT++ 鱼塘",
    "gtpp.recipe.spargetower": "GT++ 鼓泡塔",
    "gtpp.recipe.cryogenicfreezer": "GT++ 低温冷冻机",
    ...
    "gtpp.recipe.flotationcell": "GT++ 浮选池",
    ...
    "gt.recipe.electricimplosioncompressor": "电力内爆压缩机",
}
